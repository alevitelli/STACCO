...
export default function MoviePageClient({
  ...
  const selectedDate = searchParamsHook.get('date') || new Date().toISOString().split('T')[0]
  const selectedCinema = searchParamsHook.get('cinema')
  const selectedLanguage = searchParamsHook.get('language')
  const selectedTime = searchParamsHook.get('time')
  ...
  const showtimesByCinema: Record<string, Showtime[]> = movieData.showtimes.reduce((acc: { [key: string]: Showtime[] }, showtime: Showtime) => {
            ...
            <div className="md:w-2/3">
              ...
              <div className="mt-6 sm:mt-8">
                ...
                <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
                  {(Object.entries(showtimesByCinema) as [string, Showtime[]][]).map(([cinema, showtimes]) => (
